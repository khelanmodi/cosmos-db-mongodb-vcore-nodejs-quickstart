...
var tags = {
  ...
  repo: 'https://github.com/azure-samples/cosmos-db-mongodb-vcore-nodejs-quickstart'
}
...
module containerAppsJsApiApp 'br/public:avm/res/app/container-app:0.16.0' = {
  name: 'container-apps-js-api-app'
  params: {
    name: 'container-app-jsa-${resourceToken}'
    environmentResourceId: containerAppsEnvironment.outputs.resourceId
    location: location
    tags: union(tags, { 'azd-service-name': 'javascript-api' })
...
module containerAppsTsApiApp 'br/public:avm/res/app/container-app:0.16.0' = {
  name: 'container-apps-ts-api-app'
  params: {
    name: 'container-app-tsa-${resourceToken}'
    environmentResourceId: containerAppsEnvironment.outputs.resourceId
    location: location
    tags: union(tags, { 'azd-service-name': 'typescript-api' })
    ingressTargetPort: 3000
    ingressExternal: true
    ingressTransport: 'auto'
    stickySessionsAffinity: 'sticky'
...
module containerAppsJsWebApp 'br/public:avm/res/app/container-app:0.16.0' = {
  name: 'container-apps-js-web-app'
  params: {
    name: 'container-app-jsw-${resourceToken}'
    environmentResourceId: containerAppsEnvironment.outputs.resourceId
    location: location
    tags: union(tags, { 'azd-service-name': 'javascript-web' })
    ...
    secrets: [
      {
        ...
        value: 'https://${containerAppsJsApiApp.outputs.fqdn}'
      }
    ]
    containers: [
      {
...
module containerAppsTsWebApp 'br/public:avm/res/app/container-app:0.16.0' = {
  name: 'container-apps-ts-web-app'
  params: {
    name: 'container-app-tsw-${resourceToken}'
    environmentResourceId: containerAppsEnvironment.outputs.resourceId
    location: location
    tags: union(tags, { 'azd-service-name': 'typescript-web' })
    ingressTargetPort: 8080
    ingressExternal: true
    ingressTransport: 'auto'
    stickySessionsAffinity: 'sticky'
    ...
    secrets: [
      {
        name: 'azure-container-apps-api-endpoint'
        value: 'https://${containerAppsTsApiApp.outputs.fqdn}'
      }
    ]
    containers: [
      {
